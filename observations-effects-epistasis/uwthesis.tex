...
%\captionof{table}{Expression of ELF3 in transgenic lines (Ws background)}
...
\hline
%\textbf{TR copy number} & \textbf{Line  & Expression relative to Ws (WT)} & \textbf{CV of expression} \\
